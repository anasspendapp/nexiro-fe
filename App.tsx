...
}> = ({ onClose, onUpgrade, isProcessing }) => (
...
const DashboardHeader: React.FC<{
  ...
  onBack?: () => void;
  showBack?: boolean;
}> = ({ user, onSettings, onBack, showBack }) => (
...
const Dashboard: React.FC<{ user: User; onUpdateUser: (u: User) => void }> = ({
  user,
  onUpdateUser,
}) => {
...
// --- Landing Page ---
const LandingPage: React.FC<{ onLogin: () => void; onSignup: () => void }> = ({
  onLogin,
  onSignup,
}) => (
...
const AuthPage: React.FC<{
  ...
  onBack: () => void;
}> = ({ initialMode, onAuthSuccess, onBack }) => {
